...
[![Version](https://img.shields.io/badge/version-v1.46.4-blue)](https://github.com/kardenwort/20250913123501-kardenwort-anki-templates) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
...
| `WordDestinationInflectedForm` | The inflected form or phrase to highlight in the destination sentence. Supports multi-word phrases (separate by `;`). |
